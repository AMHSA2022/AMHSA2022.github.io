...
function Script1()
{
  // There are 5 categories so all will be used on every attempt. They can be populated directly on the slide

// Define the category calls
const Cat1Calls = [
...
// Define the answer text
const Cat1Ans = [
"Police and crime investigation",
"Limitation defences",
"Cultural training for lawyers",
"Aboriginal culture course for law students",
"plaintiffs agreed set of facts",
"Aboriginal people in custody",
"Community sanctions",
"Judges and minimum sentancing",
"Fetal Alchohol Spectrum Disorder",
"offenders with Fetal Alcohol Spectrum Disorder",
"Healing Lodges",
"culturally relevant services to inmates",
...
const Cat2Ans = [
 ...
 "Aboriginal education legislation",
 "Post secondary education funding",
 "Early childhood education",
 "education to public servants",
 "Aboriginal content in education",
 "annual commitment to Aboriginal education",
 "education on comparative religious studies",
 "national research program to advance understanding of reconciliation.",
 "corporate sector in Canada to adopt the United Nations Declaration on the Rights of Indigenous Peoples",
 "revise the information kit for newcomers to Canada",
 "replace the Oath of Citizenship",
 "No topic"];
const Cat3Ans = [
 "Children in care",
 "Annual reports about chilren in care.",
 "Jordan's Principle",
 ...
 "Courses for aboriginal health issues",
 "National network to share information",
 "Records on the deaths of Aboriginal children in the care of residential school authorities",
 "National Residential School Student Death Registry",
 "Online registry of residential school cemeteries",
 "Child’s burial location",
 "Residential school cemeteries ",
 "The work of documenting, maintaining, commemorating, and protecting residential school cemeteries",];
const Cat4Ans = [
 "Language rights",
 "Aboriginal Language Act",
 "Aboriginal Languages Commissioner",
 "Aboriginal Language degrees and diplomas",
 "Reclaiming names",
 ...
 "Residential Schools National Monument in the city of Ottawa",
 "Residential Schools Monument in each capital city",
 "Canada Council for the Arts strategy for collaborative projects",
 "enabling Canada’s national public broadcaster to support reconciliation",
 "Aboriginal Peoples Television Network",
 "journalism programs to require education on the history of Aboriginal peoples",
 "national story of Aboriginal athletes",
 "long-term Aboriginal athlete development and growth",
 "Physical Activity and Sport Act to support reconciliation",
 "National sports policies, programs, and initiatives are inclusive of Aboriginal peoples",
 "sporting events to ensure that Indigenous peoples’ territorial protocols are respected"];
const Cat5Ans = [
 "Call 99 is a gimme",
 "United Nations Declaration on the Rights of Indigenous Peoples",
 "Achieving the goals of the United Nations Declaration",
 "Royal Proclamation of Reconciliation",
 "Signing a Covenant of Reconciliation",
 "Repudiating concepts used to justify European sovereignty",
 "Church parties to adopt the principles, norms and standards of the United Nations Declaration",
 "religious denominations to repudiate concepts used to justify European sovereignty ",
 "Indigenous law and access to justice",
 "publishing legal opinions",
 "Title claims",
 "establish a National Council for Reconciliation",
 "funding for the National Council of Reconciliation",
 "reporting on the progress towards reconciliation",
 "annual “state of Aboriginal Peoples” report",
 "Pope to issue an apology to Survivors",
 "congregations learn about their church’s role in colonization",
 "develop and teach curriculum for all student clergy",
 "funding to Aboriginal people for ",
 "copies of all records relevant to the history and legacy of the residential school system",
 "funding contribution of $10 million over seven years to the National Centre for Truth and Reconciliation"];

// draw 5 random numbers, one for each category. These represent the starting point for teh q sequence 
var C1Qseq = Math.floor(Math.random() * 18) + 1;  	
var C2Qseq = Math.floor(Math.random() * 16) + 1;
var C3Qseq = Math.floor(Math.random() * 19) + 1;
var C4Qseq = Math.floor(Math.random() * 22) + 1;
var C5Qseq = Math.floor(Math.random() * 21) + 1;

// Populate the question variables for each category
var C1q1 = (C1Qseq  % 18);						
var C1q2 = ((C1Qseq  + 1 ) % 18);
var C1q3 = ((C1Qseq  + 2 ) % 18);
var C1q4 = ((C1Qseq  + 3 ) % 18);
var C1q5 = ((C1Qseq  + 4 ) % 18);

var C2q1 = (C2Qseq  % 16);						
var C2q2 = ((C2Qseq  + 1 ) % 16);
var C2q3 = ((C2Qseq  + 2 ) % 16);
var C2q4 = ((C2Qseq  + 3 ) % 16);
var C2q5 = ((C2Qseq  + 4 ) % 16);

var C3q1 = (C3Qseq  % 19);						
var C3q2 = ((C3Qseq  + 1 ) % 19);
var C3q3 = ((C3Qseq  + 2 ) % 19);
var C3q4 = ((C3Qseq  + 3 ) % 19);
var C3q5 = ((C3Qseq  + 4 ) % 19);

var C4q1 = (C4Qseq  % 22);						
var C4q2 = ((C4Qseq  + 1 ) % 22);
var C4q3 = ((C4Qseq  + 2 ) % 22);
var C4q4 = ((C4Qseq  + 3 ) % 22);
var C4q5 = ((C4Qseq  + 4 ) % 22);

var C5q1 = (C5Qseq  % 21);						
var C5q2 = ((C5Qseq  + 1 ) % 21);
var C5q3 = ((C5Qseq  + 2 ) % 21);
var C5q4 = ((C5Qseq  + 3 ) % 21);
var C5q5 = ((C5Qseq  + 4 ) % 21);



// Define the player
var player = GetPlayer();	// define the player
 
// Set the player question text variables with the text drawn from the category arrays
player.SetVar("C1Q1",Cat1Calls[C1q1]); 
player.SetVar("C1Q2",Cat1Calls[C1q2]); 
player.SetVar("C1Q3",Cat1Calls[C1q3]); 
player.SetVar("C1Q4",Cat1Calls[C1q4]); 
player.SetVar("C1Q5",Cat1Calls[C1q5]); 

player.SetVar("C2Q1",Cat2Calls[C2q1]); 
player.SetVar("C2Q2",Cat2Calls[C2q2]); 
player.SetVar("C2Q3",Cat2Calls[C2q3]); 
player.SetVar("C2Q4",Cat2Calls[C2q4]); 
player.SetVar("C2Q5",Cat2Calls[C2q5]); 

player.SetVar("C3Q1",Cat3Calls[C3q1]); 
player.SetVar("C3Q2",Cat3Calls[C3q2]); 
player.SetVar("C3Q3",Cat3Calls[C3q3]); 
player.SetVar("C3Q4",Cat3Calls[C3q4]); 
player.SetVar("C3Q5",Cat3Calls[C3q5]); 

player.SetVar("C4Q1",Cat4Calls[C4q1]); 
player.SetVar("C4Q2",Cat4Calls[C4q2]); 
player.SetVar("C4Q3",Cat4Calls[C4q3]); 
player.SetVar("C4Q4",Cat4Calls[C4q4]); 
player.SetVar("C4Q5",Cat4Calls[C4q5]); 

player.SetVar("C5Q1",Cat5Calls[C5q1]); 
player.SetVar("C5Q2",Cat5Calls[C5q2]); 
player.SetVar("C5Q3",Cat5Calls[C5q3]); 
player.SetVar("C5Q4",Cat5Calls[C5q4]); 
player.SetVar("C5Q5",Cat5Calls[C5q5]); 


// Set the player Answer text variables with the text drawn from the answer arrays
player.SetVar("C1A1",Cat1Ans[C1q1]); 
player.SetVar("C1A2",Cat1Ans[C1q2]); 
player.SetVar("C1A3",Cat1Ans[C1q3]); 
player.SetVar("C1A4",Cat1Ans[C1q4]); 
player.SetVar("C1A5",Cat1Ans[C1q5]); 

player.SetVar("C2A1",Cat2Ans[C2q1]); 
player.SetVar("C2A2",Cat2Ans[C2q2]); 
player.SetVar("C2A3",Cat2Ans[C2q3]); 
player.SetVar("C2A4",Cat2Ans[C2q4]); 
player.SetVar("C2A5",Cat2Ans[C2q5]); 

player.SetVar("C3A1",Cat3Ans[C3q1]); 
player.SetVar("C3A2",Cat3Ans[C3q2]); 
player.SetVar("C3A3",Cat3Ans[C3q3]); 
player.SetVar("C3A4",Cat3Ans[C3q4]); 
player.SetVar("C3A5",Cat3Ans[C3q5]); 

player.SetVar("C4A1",Cat4Ans[C4q1]); 
player.SetVar("C4A2",Cat4Ans[C4q2]); 
player.SetVar("C4A3",Cat4Ans[C4q3]); 
player.SetVar("C4A4",Cat4Ans[C4q4]); 
player.SetVar("C4A5",Cat4Ans[C4q5]); 

player.SetVar("C5A1",Cat5Ans[C5q1]); 
player.SetVar("C5A2",Cat5Ans[C5q2]); 
player.SetVar("C5A3",Cat5Ans[C5q3]); 
player.SetVar("C5A4",Cat5Ans[C5q4]); 
player.SetVar("C5A5",Cat5Ans[C5q5]); 


// trouble shooting
player.SetVar("c1qseq",C1Qseq); 
player.SetVar("C1Q1num",C1q1); 

}

function Script2()
{
  // This script Abbreviates the Question text (the call) to the first 3 charachters
// i.e. the call number which is displayed as button txt

// Define the player
var player = GetPlayer();	// define the player

// get the choice prefix'savePreferences
var CH1fTxt = player.GetVar("PlayQ"); 
var CH2fTxt = player.GetVar("PlayWrong1"); 
var CH3fTxt = player.GetVar("PlayWrong2"); 
var CH1Txt = CH1fTxt.substr(0,3);
var CH2Txt = CH2fTxt.substr(0,3);
var CH3Txt = CH3fTxt.substr(0,3);

// return the abbrev txt
// player.SetVar("PlayQ",CH1Txt); 
// player.SetVar("PlayWrong1",CH2Txt); 
// player.SetVar("PlayWrong2",CH3Txt); 

// record which answer is correct
player.SetVar("CorrectAnswer", CH1Txt); 

// get a  random number between 1 and 3
var RandSeq = Math.floor(Math.random() * 3) + 1; 
// player.SetVar("RandSeq",RandSeq); // test stub

// Define an array of answers
const RandAnswer = [CH1Txt,CH2Txt,CH3Txt];
player.SetVar("Tr1",RandAnswer[2]);

// Define the choices
var Choice1 = (RandSeq % 3);						
var Choice2 = ((RandSeq + 1 ) % 3);
var Choice3 = ((RandSeq + 2 ) % 3);

// return the abbrev txt for the buttons
player.SetVar("PlayQ",RandAnswer[Choice1] ); 
player.SetVar("PlayWrong1",RandAnswer[Choice2] ); 
player.SetVar("PlayWrong2",RandAnswer[Choice3] ); 
}
...
function Script27()
{
  // Takes the elapsed time from SL and converts it from Milliseconds to Seconds and minutes

// Define teh player
var player = GetPlayer();	// define the player

//Get the elapsed time for the scene
var ETScene = player.GetVar("ETMs");

//Convert milliseconds to seconds
var TSec = Math.floor(ETScene / 1000 );

//Calculate the whole minutes
var EMin = Math.floor(TSec / 60 );

// Calculate the remaining seconds
var ESec = Math.floor(TSec % 60 );

// return the minutes and seconds to Storyline
player.SetVar("ETmin", EMin ); 
player.SetVar("ETSec", ESec ); 
